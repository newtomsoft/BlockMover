...
public class TreeTest
{
    ...
    public void TestNoExit2In3By3()
    {
        ...
        node.GetWayToExit().ShouldBe("No way");
    }
    ...
    public void Test3In4By4()
    {
        ...
        new Node(grid).GetWayToExit().ShouldBe("b2- b1++ b0++");
    }
    ...
    public void Test4In4By4()
    {
        ...
        new Node(grid).GetWayToExit().ShouldBe("b2- b3-- b1++ b0++");
    }
    ...
    public void Test5In4By4()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b2++ b3- b4- b1++ b0++");
    }
    ...
    public void Test6In5By5()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b1-- b4-- b5++ b0+++");
    }
    ...
    public void Test8In5By5()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b1- b2- b7+ b0+");
    }
    ...
    public void Test7In6By6()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b1+ b3-- b4--- b5- b6++ b0++++");
    }
    ...
    public void Test6In6By6()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b2+++ b3+++ b1++ b4-- b0++++");
    }

    [Fact]
    public void Test8In5By5Ex2() //easy-30
    {
        var grid = new Grid(new GridSize(5, 5), Coordinate.From(4, 2));
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b1- b4++ b0- b5--- b3-- b6++ b7++ b0+++");
    }

    [Fact]
    public void Test9In5By5Ex2() //easy-50
    {
        var grid = new Grid(new GridSize(6, 6), Coordinate.From(5, 2));
        _ = new Block(0, 2, Orientation.Horizontal, Coordinate.From(0, 2), grid);
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b1+ b2- b5-- b3---- b6- b4- b7++ b8+++ b0++++");
    }
    ...
    public void TestMedium40_11In6By6()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b4- b5- b8++ b10+ b9+ b1+ b7- b0+++ b7+ b1- b9- b0+");
    }
    ...
    public void TestMedium50_9In6By6()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b4- b3-- b5--- b6+ b0++ b4--- b0- b6--- b1--- b2--- b6+++ b8+++ b0+++");
    }
    ...
    public void TestAdvanced50_11In6By6()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b5+ b8++ b3-- b9-- b4- b10--- b4+ b5+ b9+++ b2- b10- b0++++");
    }
    ...
    public void TestExpert50_10In6By6()
    {
        ...
        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b1- b4+++ b6+ b7- b2+++ b5+++ b0- b6--- b2- b3-- b4-- b7+++ b9+ b8+ b1++ b6- b0+++ b6+ b1- b8- b0+");
    }
    ...
    public void Test4()
    {
        ...
        _ = new Block(3, 2, Orientation.Horizontal, Coordinate.From(4, 3), grid);
        _ = new Block(4, 3, Orientation.Horizontal, Coordinate.From(3, 5), grid);
        _ = new Block(5, 3, Orientation.Vertical, Coordinate.From(5, 0), grid);
        _ = new Block(6, 2, Orientation.Vertical, Coordinate.From(3, 1), grid);
        _ = new Block(7, 2, Orientation.Vertical, Coordinate.From(2, 2), grid);
        _ = new Block(8, 2, Orientation.Vertical, Coordinate.From(2, 4), grid);


        var node = new Node(grid);
        node.GetWayToExit().ShouldBe("b1+ b2- b7-- b3---- b6++ b8- b4- b5+++ b0++++");
    }
}
